...
Check the [releases](https://github.com/droboports/svn/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/svn.git
cd svn
./build.sh
ls -la *.tgz
```
...
* serf: https://serf.googlecode.com/
